...
import 'package:flutter_example/game/screen/s_cpu_input.dart';
import 'package:flutter_example/game/screen/s_game_result.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(child: GameResult(isDone: isDone, result: _getResult(), callback: reset)),
        Expanded(
            child: UserInput(
